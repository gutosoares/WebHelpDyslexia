...
var widgetUI = {
  ...
  createFontSizeControl: function(property) {
    var container = $('<div>',{
      class: 'chromexia-control chromexia-left'
    });

    var select = $('<select>', {
      id: 'chromexia-select-font-size',
      class: 'chromexia-select',
      title: 'Tamanho da fonte'
    })
    .change(function() {
       chromexia.style.cache.fontSize = $(this).val();
      console.log('letter_spacing: ' + chromexia.style.cache.letter_spacing);
  ...
  createLetterSpacingControl: function(property) {
    ...
    var select = $('<select>', {
      id: 'chromexia-select-letter-spacing',
      class: 'chromexia-select',
      title: 'Espaçamento entre caracteres'
    })
    .change(function() {
       chromexia.style.cache.letter_spacing = $(this).val();
  ...
  createLineHeightControl: function(property) {
    ...
    var select = $('<select>', {
      id: 'chromexia-line-spacing',
      class: 'chromexia-select',
      title: 'Espaçamento entre linhas'
    })
    .change(function() {
       chromexia.style.cache.line_height = $(this).val();
       console.log(chromexia.style.cache.line_height);
       chromexia.style.addStylesheetRules();
    })
    .appendTo(container);
  ...
  createParagraphSpacingControl: function(property) {
    ...
    .change(function() {
       chromexia.style.cache.paragraph_spacing = $(this).val();
      console.log(chromexia.style.cache.paragraph_spacing);
       chromexia.style.addStylesheetRules();
    })
    .appendTo(container);
  ...
  createTextWidthControl: function(property) {
    var container = $('<div>',{
      class: 'chromexia-left'
    });

    var select = $('<select>', {
      id: 'chromexia-text-width',
      class: 'chromexia-select',
      title: 'Largura do texto'
    })
    .change(function() {
       chromexia.style.cache.text_width = $(this).val();
       chromexia.style.addStylesheetRules();
    })
    .appendTo(container);
  ...
  createFontFamilyControl: function(property) {
    ...
    var select = $('<select>', {
      id: 'chromexia-select-font-family',
      class: 'chromexia-select chromexia-font-family',
      title: 'Tipo da fonte'
    })
    .change(function() {
      chromexia.style.cache.font_family = $(this).val();
      console.log(chromexia.style.cache.font_family);
      chromexia.style.addStylesheetRules();
    })
     .appendTo(container);
  ...
  createFontColorControl: function() {
    ...
    var select = $('<div>', {
      ...
      class: 'chromexia-color',
      title: 'Cor do texto'
    })
    .change(function() {
       //chromexia.style.font_family = $(this).val();
       //console.log(chromexia.style.font_family);
    })
     .spectrum({
 ...
 /**
  ...
  createBackgroundColorControl: function() {
    ...
    var select = $('<div>', {
     ...
     var select_color =  $('<div>', {
      id: 'chromexia-set-backgorund-color',
    })
    .appendTo(select);
  ...
  createLighterControl: function() {
	...
	.click(function() {
		...
		obj.setAttribute("id", "chromexia-colorir*"+controlid);
  ...
  setBackgroundColor: function(color) {
    chromexia.style.cache.background_color = color.toHexString();

    // Modifica a cor da borda do ícone do plano de fundo
    $("#chromexia-set-backgorund-color").css("border-color", color.toHexString());
  ...
  setLighterColor: function(color) {
	...
	//alert(document.getElementById('chromexia-colorir'+controlid).innerHTML);
	
	document.getElementById('chromexia-colorir*'+controlid).style.setProperty('background-color', cor, 'important');
	//document.getElementById('chromexia-colorir'+controlid).style.backgroundColor = (cor);
  },
  ...
  setFontColor: function(color) {
    chromexia.style.cache.font_color = color.toHexString();

    // Modifica a cor da borda do ícone do plano de fundo
    $("#chromexia-set-font-color").css("border-color", color.toHexString());
